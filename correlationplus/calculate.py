...
def calcMDnDCC(topology, trajectory, startingFrame=0, endingFrame=(-1),
    ...
    calphas = universe.select_atoms("resname AMB and name C22")
    N = calphas.n_atoms
    ...
    if alignTrajectory:
        ...
        alignment = align.AlignTraj(universe, universe, select="resname AMB and name C22", in_memory=True)
        alignment.run()
...
def calcMD_LMI(topology, trajectory, startingFrame=0, endingFrame=(-1),
               normalized=True, alignTrajectory=True,
               atomSelection="resname AMB and name C22",
    ...
    if alignTrajectory:
        ...
        alignment = align.AlignTraj(universe, universe,
                                    select="resname AMB and name C22", in_memory=True)
        alignment.run()
